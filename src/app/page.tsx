...
export default function Home() {
  return (
      <div className="bg-slate-50 ">
          <section>
            <MaxWidthWrapper className="pb-24 pt-10 lg:flex lg:flex-row sm:pb-32 
            lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52 overflow-hidden">
              <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
                  ...
                  flex flex-col items-center lg:items-start">
                    ...
                    md:text-6xl lg:text-7xl">
                      Your image on a <span className="bg-green-600 px-2 mr-4 text-white">Custom</span> 
                    Phone Case
                    </h1>
                    <p className="mt-8 text-lg lg:pt-10 max-w-prose text-center
                    ...
                    <ul className="mt-8 space-y-2 text-left font-medium flexx
                    ...
                    ">
                      ...
                      <p><span className="font-semibold">1.250 </span> happy costumers</p>
                    </div>
                  </div>
              </div>
              ...
              px-8 sm-px:16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
                <div className="relative md:max-w-xl">
                  <img src="/your-image.png" alt="phone picture" className="absolute w-40 lg:w-52 left-56 -top-20
          ...
          <section className="bg-slate-100 py-24">
            ...
            className="flex flex-col items-center gap-16 sm:gap-32">
                <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
                  ...
                  ">
                    What our 
                    <span className="relative px-2"> costumers 
                    <Icons.underline className="hidden sm:block 
                      pointer-events-none absolute inset-x-0 -bottom-6 text-green-600" /> </span> say
                  </h2>
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
                  ...
                  <div className="text-lg leading-8">
                    <p>
                      ...
                      and <span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>, on the case I had before, the image started fading into yellow-ish colot after a couple weeks. Love it."
                    </p>
                  </div>
                  <div className="flex gap-4 mt-2">
                    <img className="rounded-full h-12 w-12 object-cover" src="/users/user-1.png" alt="user 1 photo" />
                  ...
                  <div className="text-lg leading-8">
                    <p>
                      "I usually keep my phone together with my keys in my pocket and that led to some pretty heavy scrathmarks on all of my last phone cases.
                  ...
                  <div className="flex gap-4 mt-2">
                    <img className="rounded-full h-12 w-12 object-cover" src="/users/user-4.jpg" alt="user 1 photo" />
                    <div className="flex flex-col">
              ...
              <MaxWidthWrapper className="py-24">
                  <div className="mb-12 px-5 lg:px-8">
                    ...
                    <h2 className="order-1 mt-2 tracking-tight text-center text-balance
                      ...
                      ">
                        ...
                        <span className="relative mx-2 px-2 bg-green-600 text-white">your own case 
                         </span>now
                    </h2>
                  ...
                  <div className="mx-auto max-w-6xl px-6 lg:px:8">
                    <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
                      <img src="/arrow.png" className="absolute top-[25rem] md:top-1/2 -translate-y-1/2 z-10
                      ...
                      <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm 
                            ...
                            <img src="/horse.jpg" className="rounded-md object-cover bg-white shadow-2xl ring-1 
