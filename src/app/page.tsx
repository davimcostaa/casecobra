...
export default function Home() {
  return (
    <div className='bg-slate-50 '>
      <section>
        <MaxWidthWrapper
          className='pb-24 pt-10 lg:flex lg:flex-row sm:pb-32 
        ...
        >
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            ...
            >
              ...
              >
                Your image on a{' '}
                <span className='bg-green-600 px-2 mr-4 text-white'>
                  Custom
                </span>
                Phone Case
              </h1>
              <p
                className='mt-8 text-lg lg:pt-10 max-w-prose text-center
              ...
              <ul
                className='mt-8 space-y-2 text-left font-medium flexx
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='text-lg leading-8'>
                <p>
                  ...
                  pocket and that led to some pretty heavy scrathmarks on all of
            ...
            <div className='mb-12 px-5 lg:px-8'>
              <div className='mx-auto max-w-2xl sm:text-center'>
                ...
                >
                  ...
                  <span className='relative mx-2 px-2 bg-green-600 text-white'>
                    your own case
                  </span>
                  now
                </h2>
